        ...
        <section class="dark:bg-gray-100 dark:text-gray-800">
            <div
                ...
                <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                    <h1 class="text-5xl font-bold leading-none sm:text-6xl">Services
                        <span class="dark:text-violet-600">Features</span>
                    </h1>
                </div>
            </div>
        </section>
        <section class="p-4 my-6 md:p-8 dark:bg-gray-100 dark:text-gray-800">
            <div class="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
                <Link :href="route('Pdf2Pdf')"
                    class="flex overflow-hidden rounded-lg dark:bg-gray-50 dark:text-gray-800">
                    <div class="flex items-center justify-center px-4 dark:bg-violet-600 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between flex-1 p-3">
                        <p class="text-2xl font-semibold">PDF</p>
                        <p>Convert to Scanable and ATS PDF</p>
                    </div>
                </Link>
